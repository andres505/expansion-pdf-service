...
async def generate_pdf(
    ...
    # -------------------------------------------------
    # Decisiones (ya vienen desde n8n)
    # -------------------------------------------------
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        # -------------------------------------------------
        # Benchmark regional vs sitio
        # -------------------------------------------------
        benchmark_table = build_benchmark_table(payload=payload)
        payload["benchmark_table"] = benchmark_table
        ...
        generate_expansion_pdf(
            ...
            logo_path="app/assets/logo_neto.png",  # placeholder / ignorado si no existe
